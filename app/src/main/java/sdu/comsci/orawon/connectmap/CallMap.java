package sdu.comsci.orawon.connectmap;
...
public class CallMap extends AppCompatActivity {
    ...
    public void runCallMap(View view) {
        ...
        Uri location = Uri.parse("http://maps.google.com/maps?z=10&q=loc:13.759774,100.541525");
        Intent mapIntent = new Intent(Intent.ACTION_VIEW, location);
        //ใช้ไม่ได้กับจินนี่โมชั่น mapIntent.setPackage("com.google.android.apps.maps");
